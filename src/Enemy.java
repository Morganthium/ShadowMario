...
public class Enemy {
    ...
    public Enemy(int x, int y, Properties props) {
        ...
        // Initialize RandomMovementComponent with maximum displacement
        this.maxDisplacement = Integer.parseInt(props.getProperty("gameObjects.enemy.maxRandomDisplacementX"));
    ...
    /***
     * Method that moves the enemy based on the player's movement and randomly.
     */
    private void move(Input input) {
        ...
        this.x += randomMovement.getDisplacement();
    }
    ...
    public void updateWithoutDamage(Input input, Player target) {
        move(input);
        image.draw(x, Y);
        // Do not apply damage
    }
